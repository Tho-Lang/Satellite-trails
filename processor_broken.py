...
HESSDST = '/lfs/l7/hess/users/marandon/CalibData/CT5/hddata_NewScheme2/'
...
def calc_filepath(runnumber,dstname=HESSDST):
    ...
    filepath = HESSDST+'run'+lowbound+'-'+highbound+'/run'+runnumber+'/run_'+runnumber+'_HVBrokenPixel_002.root'
    return filepath
...
print(sash_data,dir(sash_data),f,dir(f))

events = f.Get("CT1_HVBrokenPixel")
...
print(events.Dump(),events.GetIterators(),events.EventLoop())
